...
several schemas, each specifying a basic type and zero or more clauses. Note
that a Sah schema is a data structure, either a string, array, hash, or a
...
the array form to save even some typing:
