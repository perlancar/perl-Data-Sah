...
a dotted-separated series of parts, e.g. C<alt.locale.id_ID>. As with clauses,
...
to store alternative value for different locale. This applies to clauses which
