package Data::Schema::Emitter::Human;
# ABSTRACT: Emit human text from Data::Schema schema
...
(Data::Schema::Lang::*::$lang) by invoking translate() in each of
