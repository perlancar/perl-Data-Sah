...
Note: if you want to see example schemas, see L<Sah::Manual::Cookbook::Schemas>.
...
method. E.g:
 ...
 dd Sah::Type::Str::clausearg_match();
...
See documentation in Sah::Func::* (e.g. in L<Sah::Func::Std>) to find out more
about each function.
