...
See L<Sah::Manual::Function> for details on adding a new function.
...
After that, add emit code for each emitter you want. Example:
 ...
 package Sah::Emitter::Perl::Type::Complex;
 ...

 package Sah::Emitter::Human::Type::Complex;
 ...

 package Sah::Emitter::JS::Type::Complex;
 ...
...
L<Sah::Manual::Schema/"SUBSCHEMA">

L<Sah::Manual::Function>
