...
my %attrs_comparable;
$attrs_comparable{in}       = $sch_array_of_any;
$attrs_comparable{not_in}   = $attrs_comparable{one_of};
...
$attrs_sortable{xmin}         = $attrs_sortable{min};
$attrs_sortable{xmax}         = $attrs_sortable{min};
$attrs_sortable{between}      = [array => {set=>1, len=>2, elem=>[$attrs_sortable{min}, $attrs_sortable{max}]}];
$attrs_sortable{xbetween}     = [array => {set=>1, len=>2, elem=>[$attrs_sortable{min}, $attrs_sortable{max}]}];
...
$attrs_int{div_by}      = [either=>{of=>[ [int=>{set=>1, not=>0}] ,
                                                [array=>{set=>1, of=>[int=>{set=>1, not=>0}]}] ]}];
$attrs_int{indiv_by}    = $attrs_int{divisible_by};
_add_deps(['int'], \%attrs_int);
...
$attrs_hash{keys_in}                  = $sch_array_of_str;
$attrs_hash{allowed_keys}             = $attrs_hash{keys_one_of};
$attrs_hash{values_in}                = $sch_array_of_any;
...
$attrs_hash{codep_keys}               = $attrs_hash{conflicting_keys};
$attrs_hash{codep_keys_regex}         = $attrs_hash{conflicting_keys_regex};
